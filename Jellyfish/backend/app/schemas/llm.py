...
class ProviderBase(BaseModel):
    ...
    remark: str = Field("", description="Provider usage remark, such as text/image/video")
...
class ProviderUpdate(BaseModel):
    ...
    remark: str | None = Field(None, description="Provider usage remark, such as text/image/video")
...
class ModelDiscoveryItem(BaseModel):
    ...
    name: str = Field(..., description="Provider model name")
    category: ModelCategoryKey = Field(..., description="Model capability category")
    description: str = Field("", description="Model capability description")


class ModelDiscoveryRead(BaseModel):
    """Provider discovery result kept separate from persisted model records."""

    provider_id: str = Field(..., description="Provider ID")
    models: list[ModelDiscoveryItem] = Field(default_factory=list, description="Discovered models")
    source: str = Field(..., description="Discovery source: remote or fallback")
