...
import type { ApiResponse_ModelDiscoveryRead_ } from '../models/ApiResponse_ModelDiscoveryRead_';
...
export class LlmService {
     ...
     * Discover remote models without exposing provider credentials.
     * @returns ApiResponse_ModelDiscoveryRead_ Successful Response
     * @throws ApiError
     */
    public static discoverProviderModelsApiV1LlmProvidersProviderIdDiscoverModelsGet({
        providerId,
    }: {
        providerId: string,
    }): CancelablePromise<ApiResponse_ModelDiscoveryRead_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/llm/providers/{provider_id}/discover-models',
            path: {
                'provider_id': providerId,
            },
            errors: {
