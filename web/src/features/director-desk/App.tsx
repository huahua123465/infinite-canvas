...
type DirectorDeskAppProps = {
  onClose?: () => void;
};

export default function App({ onClose }: DirectorDeskAppProps) {
      ...
      <main className="director-home-shell">
        <section className="director-home-hero">
          ...
          <div className="director-home-hero-actions">
            ...
            <button className="director-home-return-button" type="button" onClick={handleClose}>
