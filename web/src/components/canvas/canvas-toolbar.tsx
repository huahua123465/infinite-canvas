...
import { CircleDot, Clapperboard, Eraser, FileInput, FileText, FolderOpen, Grid2x2, Group, Hand, Image as ImageIcon, Info, MonitorPlay, Moon, Music2, Palette, Puzzle, Redo2, Settings2, Square, Sun, Trash2, Type, Undo2, Upload, Video } from "lucide-react";
    ...
    return (
        <div className="pointer-events-none absolute bottom-5 z-50 flex justify-center" style={{ left: 300, right: 16 }}>
            ...
            <div ref={wrapRef} className="thin-scrollbar pointer-events-auto flex h-14 max-w-full items-center gap-1 overflow-x-auto rounded-xl border px-2 shadow-lg backdrop-blur [&>*]:shrink-0" style={dockStyle}>
                ...
                <ToolbarButton id="tool-script" label="Script" hovered={hovered} hoverStyle={hoverStyle} wrapRef={wrapRef} onTipX={setTipX} onHover={setHovered} onClick={onAddScript}>
                ...
                <ToolbarButton id="tool-manga-storyboard" label="导入分镜" hovered={hovered} hoverStyle={hoverStyle} wrapRef={wrapRef} onTipX={setTipX} onHover={setHovered} onClick={onImportMangaStoryboard}>
                    <FileInput className="size-4.5" />
                </ToolbarButton>
                <ToolbarButton id="tool-scene-360" label="导入360场景" hovered={hovered} hoverStyle={hoverStyle} wrapRef={wrapRef} onTipX={setTipX} onHover={setHovered} onClick={onImportScene360}>
                ...
                <ToolbarButton id="tool-toonflow" label="打开 ToonFlow" hovered={hovered} hoverStyle={hoverStyle} wrapRef={wrapRef} onTipX={setTipX} onHover={setHovered} onClick={onOpenToonflow}>
...
function toolLabel(id: string) {
    ...
    if (id === "tool-script") return "Script";
    ...
    if (id === "tool-toonflow") return "打开 ToonFlow";
